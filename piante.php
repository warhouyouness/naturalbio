...
<html>
	...
	<body ng-app="myApp" ng-controller="myCtrl"> <?php include_once("analyticstracking.php") ?>
        ...
        <div class="main">
			<div class="panel" >
				<div class="menuricette" ng-show="bar == 2">
					<a href="oli.php" class="m" >
						<img src="./img/face.png">
						<div class="txt">Oli</div>
					</a>
					<a class="m sfo" href="piante.php"ng-show="cat == 5">
						<img src="./img/body.png">
						<div class="txt">Piante e Fiori</div>
					
                    </a>
					<a class="m" href="altro.php">
                      
						<img src="./img/hair.png">
						<div class="txt">Altro</div>
